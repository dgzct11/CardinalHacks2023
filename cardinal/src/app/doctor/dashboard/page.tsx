...
const DoctorDashboard = () => {
    ...
    return (
      <div className="min-h-screen bg-blue-50 text-gray-900">
          {/* Navigation bar */}
          <nav className="flex justify-between items-center mb-8 bg-blue-600 p-4 rounded-md">
              <span className="text-2xl font-bold text-white">Doctor's Portal</span>
              <div>
                  <a href="#" className="mr-4 text-white hover:text-blue-200">Home</a>
          ...
          {!showPatients ? (
              ...
              <>
                  <h1 className="text-2xl font-bold pl-6 mb-4 text-black-700">Doctor Dashboard</h1>
